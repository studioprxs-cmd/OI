    ...
    <PageContainer>
      <div className="market-layout">
        <section className="hero-block compact market-hero">
          ...
          <h1>포인트 마켓</h1>
          <p>오잉에서 쌓은 포인트를 굿즈·디지털·핫딜로 바로 교환하세요. 존 탭 전환 + 이미지 중심 카드 + 구매 확인 모달을 연결해 모바일에서 더 빠르게 참여할 수 있도록 MVP 구매 플로우를 고도화했습니다.</p>
        </section>
        ...
        <StatePanel
          ...
          description="상품 목록 API(`/api/market/products`)와 주문 API(`/api/market/orders`)를 존 탭/확인 모달 UX와 연결해 포인트 차감형 구매를 더 안전하고 빠르게 실행할 수 있습니다."
          tone="success"
